...
namespace NoComp.TfsAccSwitchVS13
{
    ...
    public sealed class TfsAccSwitchVS13Package : Package, IOleCommandTarget
    {
        ...
        {
            if (pguidCmdGroup != GuidList.guidTfsAccSwitchVS13CmdSet)
            {
                return UnknownGroup;
            }
