...
namespace TfsAccSwitch_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(NoComp.TfsAccSwitch.GuidList.guidTfsAccSwitchCmdSet, (int)NoComp.TfsAccSwitch.PkgCmdIDList.cmdidChangeAccount);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "TfsAccSwitch", "NoComp.TfsAccSwitch.TfsAccSwitchPackage");
