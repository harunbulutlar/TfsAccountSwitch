...
using NoComp.TfsAccSwitch;

namespace TfsAccSwitch_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new TfsAccSwitchPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(NoComp.TfsAccSwitch.GuidList.guidTfsAccSwitchCmdSet, (int)NoComp.TfsAccSwitch.PkgCmdIDList.cmdidChangeAccount);
